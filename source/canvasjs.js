/**
* @preserve CanvasJS HTML5 & JavaScript Charts - v1.5.6 GA- http://canvasjs.com/ 
...
(function () {
	...
	Chart.prototype._updateOptions = function () {
		...
		//else if (!this.exportEnabled && this._menuButton) {
		//    hide(this._menuButton);
		//}
		//else if (this.exportEnabled && this._menuButton.style.display === "none") {
		//    show(this._menuButton);
		//}
	...
	CanvasJS.Chart.version = "v1.5.6 GA";
